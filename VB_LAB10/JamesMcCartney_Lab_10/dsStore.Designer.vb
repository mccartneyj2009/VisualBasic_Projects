...
Partial Public Class dsStore
    ...
    Partial Public Class ProductsDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddProductsRow(ByVal Product_id As Integer, ByVal ProductName As String, ByVal ProductPrice As Decimal) As ProductsRow
            Dim rowProductsRow As ProductsRow = CType(Me.NewRow,ProductsRow)
            Dim columnValuesArray() As Object = New Object() {Product_id, ProductName, ProductPrice}
...
Namespace dsStoreTableAdapters
    ...
    Partial Public Class ProductsTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Products` WHERE ((`Product_id` = ?) AND ((? = 1 AND `ProductName` IS"& _ 
                " NULL) OR (`ProductName` = ?)) AND ((? = 1 AND `ProductPrice` IS NULL) OR (`Prod"& _ 
                "uctPrice` = ?)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Products` (`Product_id`, `ProductName`, `ProductPrice`) VALUES (?, ?"& _ 
                ", ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Products` SET `Product_id` = ?, `ProductName` = ?, `ProductPrice` = ? WHE"& _ 
                "RE ((`Product_id` = ?) AND ((? = 1 AND `ProductName` IS NULL) OR (`ProductName` "& _ 
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.JamesMcCartney_Lab_10.My.MySettings.Default.storeConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Product_id, ProductName, ProductPrice FROM Products"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As dsStore.ProductsDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As dsStore.ProductsDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As dsStore.ProductsDataTable = New dsStore.ProductsDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As dsStore.ProductsDataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_Product_id As Global.System.Nullable(Of Integer), ByVal Original_ProductName As String, ByVal Original_ProductPrice As Global.System.Nullable(Of Decimal)) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal Product_id As Global.System.Nullable(Of Integer), ByVal ProductName As String, ByVal ProductPrice As Global.System.Nullable(Of Decimal)) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal Product_id As Global.System.Nullable(Of Integer), ByVal ProductName As String, ByVal ProductPrice As Global.System.Nullable(Of Decimal), ByVal Original_Product_id As Global.System.Nullable(Of Integer), ByVal Original_ProductName As String, ByVal Original_ProductPrice As Global.System.Nullable(Of Decimal)) As Integer
            If (Product_id.HasValue = true) Then
            ...
            End If
            If (Original_Product_id.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(3).Value = CType(Original_Product_id.Value,Integer)
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal ProductName As String, ByVal ProductPrice As Global.System.Nullable(Of Decimal), ByVal Original_Product_id As Global.System.Nullable(Of Integer), ByVal Original_ProductName As String, ByVal Original_ProductPrice As Global.System.Nullable(Of Decimal)) As Integer
            Return Me.Update(Original_Product_id, ProductName, ProductPrice, Original_Product_id, Original_ProductName, Original_ProductPrice)
        End Function
    End Class
